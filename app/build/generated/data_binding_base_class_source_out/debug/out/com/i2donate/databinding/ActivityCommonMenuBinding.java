...
public final class ActivityCommonMenuBinding implements ViewBinding {
  ...
  private ActivityCommonMenuBinding(@NonNull FrameLayout rootView, @NonNull ImageView browseImg,
      ...
      @NonNull Toolbar commonMenuActivityToolbar, @NonNull ImageView imageView4,
      @NonNull LinearLayout linearBrowse, @NonNull LinearLayout linearMyspace,
      @NonNull ImageView menu, @NonNull FrameLayout menuActivityFrameLayout,
  ...
  public static ActivityCommonMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCommonMenuBinding((FrameLayout) rootView, browseImg, browseTv,
          ...
          imageView4, linearBrowse, linearMyspace, menu, menuActivityFrameLayout, mySpaceImg,
          mySpaceTv, refreshMenu, tabMode);
    }
