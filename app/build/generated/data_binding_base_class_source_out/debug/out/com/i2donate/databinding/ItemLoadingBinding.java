...
public final class ItemLoadingBinding implements ViewBinding {
  ...
  private ItemLoadingBinding(@NonNull LinearLayout rootView, @NonNull ProgressBar progressBar) {
  ...
  public static ItemLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemLoadingBinding((LinearLayout) rootView, progressBar);
    }
