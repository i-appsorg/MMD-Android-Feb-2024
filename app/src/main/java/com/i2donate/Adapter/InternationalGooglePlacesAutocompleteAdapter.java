...
public class InternationalGooglePlacesAutocompleteAdapter extends RecyclerView.Adapter<InternationalGooglePlacesAutocompleteAdapter.PredictionHolder> implements Filterable {
    ...
    public InternationalGooglePlacesAutocompleteAdapter(Context context, int resource) {
        mContext = context;
        layout = resource;
    }
        ...
        Filter filter = new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence constraint) {
                ...
                if (constraint != null) {
                    ...
                    Log.e("TAG", "performFiltering: "+filterResults.toString() );
                }
