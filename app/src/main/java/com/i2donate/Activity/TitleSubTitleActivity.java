...
public class TitleSubTitleActivity extends AppCompatActivity {
...
//                iDonateSharedPreference.setadvance(getApplicationContext(),"1");
                    ...
                    Intent intent = new Intent(TitleSubTitleActivity.this, InternationalCharitiesActivity.class);
                    intent.putExtra("data","1");
//                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                iDonateSharedPreference.setadvance(getApplicationContext(),"1");
                    startActivity(intent);
                    ...
                    Intent intent = new Intent(TitleSubTitleActivity.this, NameSearchActivity.class);
                    intent.putExtra("data","1");
//                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                iDonateSharedPreference.setadvance(getApplicationContext(),"1");
                    startActivity(intent);
...
//todo login
        ...
        jsonObject1.addProperty("device_id", getDeviceUniqueID(TitleSubTitleActivity.this));
