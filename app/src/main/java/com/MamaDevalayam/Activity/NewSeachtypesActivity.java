...
import com.MamaDevalayam.Adapter.NewTypesCategorylistAdapter;
...
public class NewSeachtypesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_newsearchtypes);
        init();
        listener();
    }
    ...
    private void listener() {
        ...
        apply_button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e(TAG, "apply_button: ");
                Log.e(TAG, "dhruvi " + iDonateSharedPreference.getAdvancepage(NewSeachtypesActivity.this));
                ...
                if (iDonateSharedPreference.getAdvancepage(getApplicationContext()).equalsIgnoreCase("unitedstate")) {
                    Log.e(TAG, "dhruvi " + iDonateSharedPreference.getAdvancepage(NewSeachtypesActivity.this));
                    Intent intent = new Intent(NewSeachtypesActivity.this, UnitedStateActivity.class);
...
//                iDonateSharedPreference.setadvance(getApplicationContext(),"1");
                    ...
                    Log.e(TAG, "dhruvi " + iDonateSharedPreference.getAdvancepage(NewSeachtypesActivity.this));
                    Intent intent = new Intent(NewSeachtypesActivity.this, InternationalCharitiesActivity.class);
                    intent.putExtra("data", "1");
//                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                iDonateSharedPreference.setadvance(getApplicationContext(),"1");
                    startActivity(intent);
                    ...
                    Log.e("listOfcategory_item1", "" + TitleSubTitleActivity.listOfcategory);
                    finishAffinity();
                } else if (iDonateSharedPreference.getAdvancepage(getApplicationContext()).equalsIgnoreCase("namesearch")) {
                    Log.e(TAG, "c " + iDonateSharedPreference.getAdvancepage(NewSeachtypesActivity.this));
                    Intent intent = new Intent(NewSeachtypesActivity.this, NameSearchActivity.class);
                    Log.e(TAG, "NameSearchActivity:----- ");
                    intent.putExtra("data", "1");
//                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                iDonateSharedPreference.setadvance(getApplicationContext(),"1");
                    startActivity(intent);
                    ...
                    Log.e(TAG, "TypeSerchActivity:----- ");
                    Intent intent = new Intent(NewSeachtypesActivity.this, TypeSerchActivity.class);
                    intent.putExtra("data", "1");
//                intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP | Intent.FLAG_ACTIVITY_CLEAR_TOP);
//                iDonateSharedPreference.setadvance(getApplicationContext(),"1");
                    startActivity(intent);
