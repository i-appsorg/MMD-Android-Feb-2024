...
import com.MamaDevalayam.Activity.InternationalCharitiesActivity;
 ...
 */
public class LoadmoreInternationlocationAdapterList2 extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
...
List<Charitylist> names;
    ...
    public LoadmoreInternationlocationAdapterList2(Activity mContext, List<TempleListDataModel> charitylist1) {
