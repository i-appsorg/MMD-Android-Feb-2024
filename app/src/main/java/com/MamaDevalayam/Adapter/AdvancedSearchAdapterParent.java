...
public class AdvancedSearchAdapterParent extends BaseExpandableListAdapter {
    ...
    public AdvancedSearchAdapterParent(Context context, String[] headers, List<String[]> data) {
