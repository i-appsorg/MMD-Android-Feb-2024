...
public class child_categorynew {
    String child_category_id;
    String child_category_code;
    ...
    public String getChild_category_code() {
        return child_category_code;
    }

    public void setChild_category_code(String child_category_code) {
        this.child_category_code = child_category_code;
    }
